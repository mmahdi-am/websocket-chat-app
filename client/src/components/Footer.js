  ...
  return (
    ...
    <div className="container text-center py-4 py-lg-5">
        <ul className="list-inline">
            <a  href={"https://github.com/rammus301/chat-project" }   className="list-inline-item mx-2 text-white">
          درباره پروژه
          </a>
            <Link to={"/contact-us"} className="list-inline-item mx-2 text-white">
          ارتباط با ما
          </Link>
            <Link to={"/rooms"} className="list-inline-item mx-2 text-white">
          لیست اتاق ها
          </Link>
        </ul>
        <ul className="list-inline">
        ...
        <p className="text-white-50 mb-0">Copyright © 2023 </p>
    </div>
</footer>
  )
}
